...
<!-- Do not remove Exlibris work around created varible to alter current SAML delivery page -->
...
<xsl:value-of select='concat("https:/alliance-wsu.alma.exlibrisgroup.com/services/login?auth=SAML&amp;idpCode=SAML_OKTA_ALMA&amp;digitalDoc=",$DOCID)'/> 
  </xsl:variable>
...
-->
					<tr>
						<td>Or, download the document from Search It > My Account > Requests.
						</td>
					</tr>
                 </xsl:if>	
